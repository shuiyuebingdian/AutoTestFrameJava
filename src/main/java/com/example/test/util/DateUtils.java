...
public class DateUtils {
    ...
    public static String STRING_DATE_TIME_FORMAT = "yyyyMMddHHmmss";
     ...
     * @return 分钟数
     */
    public static long getMinutesByMinusDate(Object fromDate, Object toDate) {
